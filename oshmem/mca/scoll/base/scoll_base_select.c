...
static int scoll_null_alltoall_nb(struct oshmem_group_t *group,
                              void *target,
                              const void *source,
                              ptrdiff_t dst, ptrdiff_t sst,
                              size_t nlong,
...
static int scoll_null_scan(struct oshmem_group_t *group,
                           struct oshmem_op_t *op,
                           void *target,
                           const void *source,
                           size_t nlong,
...
int mca_scoll_base_select(struct oshmem_group_t *group)
{
    ...
    if ((NULL == group->g_scoll.scoll_barrier)
            ...
            || (NULL == group->g_scoll.scoll_alltoall_nb)
            || (NULL == group->g_scoll.scoll_broadcast_nb)) {
        mca_scoll_base_group_unselect(group);
