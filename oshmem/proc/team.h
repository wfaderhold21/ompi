...
/**
 * Allocate sync/work buffers for predefined teams (WORLD, SHARED).
 * Called from oshmem_shmem_init() after the symmetric heap is ready.
 *
 * @retval OSHMEM_SUCCESS   Success
 * @retval OSHMEM_ERROR    Allocation failed
 */
OSHMEM_DECLSPEC int oshmem_team_alloc_predefined_sync_buffers(void);
