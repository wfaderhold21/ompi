...
/* Scan - sum/prod iscan/escan (team-based); see shmem_scan.c for full list */
#define shmem_char_sum_iscan            pshmem_char_sum_iscan
#define shmem_short_sum_iscan           pshmem_short_sum_iscan
#define shmem_int_sum_iscan             pshmem_int_sum_iscan
#define shmem_long_sum_iscan            pshmem_long_sum_iscan
#define shmem_float_sum_iscan           pshmem_float_sum_iscan
#define shmem_double_sum_iscan          pshmem_double_sum_iscan
#define shmem_longlong_sum_iscan        pshmem_longlong_sum_iscan
#define shmem_schar_sum_iscan           pshmem_schar_sum_iscan
#define shmem_uchar_sum_iscan           pshmem_uchar_sum_iscan
#define shmem_ushort_sum_iscan          pshmem_ushort_sum_iscan
#define shmem_uint_sum_iscan            pshmem_uint_sum_iscan
#define shmem_ulong_sum_iscan           pshmem_ulong_sum_iscan
#define shmem_ulonglong_sum_iscan       pshmem_ulonglong_sum_iscan
#define shmem_longdouble_sum_iscan      pshmem_longdouble_sum_iscan
#define shmem_int8_sum_iscan            pshmem_int8_sum_iscan
#define shmem_int16_sum_iscan           pshmem_int16_sum_iscan
#define shmem_int32_sum_iscan           pshmem_int32_sum_iscan
#define shmem_int64_sum_iscan           pshmem_int64_sum_iscan
#define shmem_uint8_sum_iscan           pshmem_uint8_sum_iscan
#define shmem_uint16_sum_iscan          pshmem_uint16_sum_iscan
#define shmem_uint32_sum_iscan          pshmem_uint32_sum_iscan
#define shmem_uint64_sum_iscan          pshmem_uint64_sum_iscan
#define shmem_size_sum_iscan            pshmem_size_sum_iscan
#define shmem_ptrdiff_sum_iscan         pshmem_ptrdiff_sum_iscan
#define shmem_char_sum_escan            pshmem_char_sum_escan
#define shmem_short_sum_escan           pshmem_short_sum_escan
#define shmem_int_sum_escan             pshmem_int_sum_escan
#define shmem_long_sum_escan            pshmem_long_sum_escan
#define shmem_float_sum_escan           pshmem_float_sum_escan
#define shmem_double_sum_escan          pshmem_double_sum_escan
#define shmem_longlong_sum_escan        pshmem_longlong_sum_escan
#define shmem_schar_sum_escan           pshmem_schar_sum_escan
#define shmem_uchar_sum_escan           pshmem_uchar_sum_escan
#define shmem_ushort_sum_escan          pshmem_ushort_sum_escan
#define shmem_uint_sum_escan            pshmem_uint_sum_escan
#define shmem_ulong_sum_escan           pshmem_ulong_sum_escan
#define shmem_ulonglong_sum_escan       pshmem_ulonglong_sum_escan
#define shmem_longdouble_sum_escan      pshmem_longdouble_sum_escan
#define shmem_int8_sum_escan            pshmem_int8_sum_escan
#define shmem_int16_sum_escan           pshmem_int16_sum_escan
#define shmem_int32_sum_escan           pshmem_int32_sum_escan
#define shmem_int64_sum_escan           pshmem_int64_sum_escan
#define shmem_uint8_sum_escan           pshmem_uint8_sum_escan
#define shmem_uint16_sum_escan          pshmem_uint16_sum_escan
#define shmem_uint32_sum_escan          pshmem_uint32_sum_escan
#define shmem_uint64_sum_escan          pshmem_uint64_sum_escan
#define shmem_size_sum_escan            pshmem_size_sum_escan
#define shmem_ptrdiff_sum_escan         pshmem_ptrdiff_sum_escan
#define shmem_char_prod_iscan           pshmem_char_prod_iscan
#define shmem_short_prod_iscan          pshmem_short_prod_iscan
#define shmem_int_prod_iscan            pshmem_int_prod_iscan
#define shmem_long_prod_iscan           pshmem_long_prod_iscan
#define shmem_float_prod_iscan          pshmem_float_prod_iscan
#define shmem_double_prod_iscan         pshmem_double_prod_iscan
#define shmem_longlong_prod_iscan       pshmem_longlong_prod_iscan
#define shmem_schar_prod_iscan          pshmem_schar_prod_iscan
#define shmem_uchar_prod_iscan          pshmem_uchar_prod_iscan
#define shmem_ushort_prod_iscan         pshmem_ushort_prod_iscan
#define shmem_uint_prod_iscan           pshmem_uint_prod_iscan
#define shmem_ulong_prod_iscan          pshmem_ulong_prod_iscan
#define shmem_ulonglong_prod_iscan      pshmem_ulonglong_prod_iscan
#define shmem_longdouble_prod_iscan     pshmem_longdouble_prod_iscan
#define shmem_int8_prod_iscan           pshmem_int8_prod_iscan
#define shmem_int16_prod_iscan          pshmem_int16_prod_iscan
#define shmem_int32_prod_iscan          pshmem_int32_prod_iscan
#define shmem_int64_prod_iscan          pshmem_int64_prod_iscan
#define shmem_uint8_prod_iscan          pshmem_uint8_prod_iscan
#define shmem_uint16_prod_iscan         pshmem_uint16_prod_iscan
#define shmem_uint32_prod_iscan         pshmem_uint32_prod_iscan
#define shmem_uint64_prod_iscan         pshmem_uint64_prod_iscan
#define shmem_size_prod_iscan           pshmem_size_prod_iscan
#define shmem_ptrdiff_prod_iscan        pshmem_ptrdiff_prod_iscan
#define shmem_char_prod_escan           pshmem_char_prod_escan
#define shmem_short_prod_escan          pshmem_short_prod_escan
#define shmem_int_prod_escan            pshmem_int_prod_escan
#define shmem_long_prod_escan           pshmem_long_prod_escan
#define shmem_float_prod_escan          pshmem_float_prod_escan
#define shmem_double_prod_escan         pshmem_double_prod_escan
#define shmem_longlong_prod_escan       pshmem_longlong_prod_escan
#define shmem_schar_prod_escan          pshmem_schar_prod_escan
#define shmem_uchar_prod_escan          pshmem_uchar_prod_escan
#define shmem_ushort_prod_escan         pshmem_ushort_prod_escan
#define shmem_uint_prod_escan           pshmem_uint_prod_escan
#define shmem_ulong_prod_escan          pshmem_ulong_prod_escan
#define shmem_ulonglong_prod_escan      pshmem_ulonglong_prod_escan
#define shmem_longdouble_prod_escan     pshmem_longdouble_prod_escan
#define shmem_int8_prod_escan           pshmem_int8_prod_escan
#define shmem_int16_prod_escan          pshmem_int16_prod_escan
#define shmem_int32_prod_escan          pshmem_int32_prod_escan
#define shmem_int64_prod_escan          pshmem_int64_prod_escan
#define shmem_uint8_prod_escan          pshmem_uint8_prod_escan
#define shmem_uint16_prod_escan         pshmem_uint16_prod_escan
#define shmem_uint32_prod_escan         pshmem_uint32_prod_escan
#define shmem_uint64_prod_escan         pshmem_uint64_prod_escan
#define shmem_size_prod_escan           pshmem_size_prod_escan
#define shmem_ptrdiff_prod_escan        pshmem_ptrdiff_prod_escan
