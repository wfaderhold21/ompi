...
#if OSHMEM_HAVE_C11
#define shmemx_alltoall_nb(...)                                             \
    _Generic(&*(__OSHMEM_VAR_ARG2(__VA_ARGS__)),                        \
            char*:        shmemx_char_alltoall_nb,               	        \
            short*:       shmemx_short_alltoall_nb,              	        \
            int*:         shmemx_int_alltoall_nb,                	        \
            long*:        shmemx_long_alltoall_nb,               	        \
            long long*:   shmemx_longlong_alltoall_nb,           	        \
            signed char*:        shmemx_schar_alltoall_nb,       	        \
            unsigned char*:      shmemx_uchar_alltoall_nb,       	        \
            unsigned short*:     shmemx_ushort_alltoall_nb,      	        \
            unsigned int*:       shmemx_uint_alltoall_nb,        	        \
            unsigned long*:      shmemx_ulong_alltoall_nb,       	        \
            unsigned long long*: shmemx_ulonglong_alltoall_nb,   	        \
            float*:       shmemx_float_alltoall_nb,              	        \
            double*:      shmemx_double_alltoall_nb,             	        \
            long double*: shmemx_longdouble_alltoall_nb,         	        \
            default:      __oshmem_datatype_ignore)(__VA_ARGS__)
#endif

int shmemx_char_broadcast_nb(shmem_team_t team, char *dest, const char *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_short_broadcast_nb(shmem_team_t team, short *dest, const short *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_int_broadcast_nb(shmem_team_t team, int *dest, const int *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_long_broadcast_nb(shmem_team_t team, long *dest, const long *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_float_broadcast_nb(shmem_team_t team, float *dest, const float *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_double_broadcast_nb(shmem_team_t team, double *dest, const double *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_longlong_broadcast_nb(shmem_team_t team, long long *dest, const long long *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_schar_broadcast_nb(shmem_team_t team, signed char *dest, const signed char *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_uchar_broadcast_nb(shmem_team_t team, unsigned char *dest, const unsigned char *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_ushort_broadcast_nb(shmem_team_t team, unsigned short *dest, const unsigned short *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_uint_broadcast_nb(shmem_team_t team, unsigned int *dest, const unsigned int *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_ulong_broadcast_nb(shmem_team_t team, unsigned long *dest, const unsigned long *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_ulonglong_broadcast_nb(shmem_team_t team, unsigned long long *dest, const unsigned long long *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_longdouble_broadcast_nb(shmem_team_t team, long double *dest, const long double *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_int8_broadcast_nb(shmem_team_t team, int8_t *dest, const int8_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_int16_broadcast_nb(shmem_team_t team, int16_t *dest, const int16_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_int32_broadcast_nb(shmem_team_t team, int32_t *dest, const int32_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_int64_broadcast_nb(shmem_team_t team, int64_t *dest, const int64_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_uint8_broadcast_nb(shmem_team_t team, uint8_t *dest, const uint8_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_uint16_broadcast_nb(shmem_team_t team, uint16_t *dest, const uint16_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_uint32_broadcast_nb(shmem_team_t team, uint32_t *dest, const uint32_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_uint64_broadcast_nb(shmem_team_t team, uint64_t *dest, const uint64_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_size_broadcast_nb(shmem_team_t team, size_t *dest, const size_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
int shmemx_ptrdiff_broadcast_nb(shmem_team_t team, ptrdiff_t *dest, const ptrdiff_t *source,
                            size_t nelems, int PE_root, shmem_req_h *request);
...
#if OSHMEM_HAVE_C11
#define shmemx_broadcast_nb(...)                                             \
    _Generic(&*(__OSHMEM_VAR_ARG2(__VA_ARGS__)),                        \
            char*:        shmemx_char_broadcast_nb,               	        \
            short*:       shmemx_short_broadcast_nb,              	        \
            int*:         shmemx_int_broadcast_nb,                	        \
            long*:        shmemx_long_broadcast_nb,               	        \
            long long*:   shmemx_longlong_broadcast_nb,           	        \
            signed char*:        shmemx_schar_broadcast_nb,       	        \
            unsigned char*:      shmemx_uchar_broadcast_nb,       	        \
            unsigned short*:     shmemx_ushort_broadcast_nb,      	        \
            unsigned int*:       shmemx_uint_broadcast_nb,        	        \
            unsigned long*:      shmemx_ulong_broadcast_nb,       	        \
            unsigned long long*: shmemx_ulonglong_broadcast_nb,   	        \
            float*:       shmemx_float_broadcast_nb,              	        \
            double*:      shmemx_double_broadcast_nb,             	        \
            long double*: shmemx_longdouble_broadcast_nb,         	        \
            default:      __oshmem_datatype_ignore)(__VA_ARGS__)
#endif
